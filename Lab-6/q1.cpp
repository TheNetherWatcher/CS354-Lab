// Question 1: Diabetes Classification
#include <iostream>
#include <vector>
#include <cmath>
#include <random>
...
vector<pair<vector<double>, vector<double>>> load_diabetes_data(const string& filename) {
    ...
    while (getline(file, line)) {
        ...
        vector<double> target = {features.back()};
        features.pop_back();
...
int main() {
    cout << "Diabetes Classification Neural Network\n";
    auto data = load_diabetes_data("diabetes.csv");
    
    // Neural network with 8 input features, 7 hidden nodes, 1 output node
    NeuralNetwork nn({8, 7, 1}, 0.0001);
    
    cout << "Training for 30 epochs...\n";
